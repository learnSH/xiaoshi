...
> git 操作部分和使用github的差不多，不了解git操作的可以看我的另一篇文章：[Git使用手册](https://xiaoshiye.com/pages/9a7ee40fc232253e/)
...
# github
echo 'b.xiaoshiye.com' > CNAME
git init
git add -A
git commit -m 'deploy'
git push -f git@github.com:xiaoshiye/blog.git master:gh-pages # 发布到github

# coding
echo 'xiaoshiye.com' > CNAME
git add -A
git commit -m 'deploy'
git push -f git@git.dev.tencent.com:xiaoshiye/xiaoshiye.git master # 发布到coding
